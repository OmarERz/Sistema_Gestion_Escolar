...
import { createStudentSchema, updateStudentSchema, guardianInputSchema } from '../schemas/student.schema.js';
...
router.post('/:id/guardians', validateRequest({ body: guardianInputSchema }), studentController.addGuardian);
